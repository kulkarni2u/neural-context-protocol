#!/usr/bin/env python3
"""Consume pending NCP whispers and run OpenCode as a bounded reviewer."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cwd", type=Path, default=Path.cwd(), help="Repository root for OpenCode access.")
    parser.add_argument("--agent-id", default="opencode", help="Target agent id whose whispers should be consumed.")
    ...
    parser.add_argument("--instruction", default=None, help="Optional extra instruction for OpenCode.")
    ...
    parser.add_argument("--timeout-seconds", type=float, default=30.0, help="OpenCode timeout budget.")
...
def main() -> int:
    ...
    if not handoffs:
        raise SystemExit("No pending NCP handoffs for OpenCode.")
