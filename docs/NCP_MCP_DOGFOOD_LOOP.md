...
Last verified: **1.0.0** (2026-06-01) — `restart_persistence_ok: true`, streaming path (`"stream": true`) emits NDJSON sections before final response on HTTP and JSON-RPC notifications on stdio.
